...
#
# Copyright (C) 2008 Laurent Dubroca laurent.dubroca_at_gmail.com (Stazione Zoologica Anton Dohrn, Napoli, Italy)
...
#
   if( fdattype=="integer" ){
    ...
    for( xm in 1:length(xmins) ){
      ...
      if(xmin==1){
        #bug corrected t he 14/08/2009 thanks to Naoki Masuda
